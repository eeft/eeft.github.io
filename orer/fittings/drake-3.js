...
const pgr = new Powergrid().add(2).add(1);

const fittings = new Fitting(Drake, engi, pgr);

fittings
  .add(mods.high.missile.torpedoLauncher.medium.republicFleet.withPowergridReductionFactor(0.06), 7)
  
  .add(mods.mid.GroupBooster, 2)
  .add(mods.mid.ewar.web)

  .add(mods.low.microwarpdrive.medium.republicFleet)
  .add(mods.low.shieldExtender.medium.republicFleet)
